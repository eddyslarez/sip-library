...
/**
 * Interface mejorada para eventos de la biblioteca SIP
 * Todos los métodos tienen implementación por defecto
 *
 * @author Eddys Larez
 */
interface SipEventListener {
    // Eventos de biblioteca
    fun onLibraryInitialized(version: String) {}
    fun onLibraryDisposed() {}
    ...
    fun onTranslationStateChanged(isActive: Boolean, sourceLanguage: TranslationLanguage?, targetLanguage: TranslationLanguage?) {}
    fun onTranslationError(error: com.eddyslarez.siplibrary.translation.TranslationError) {}
